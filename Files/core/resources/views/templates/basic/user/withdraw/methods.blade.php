...
@section('content')
    <div class="container pt-100 pb-100">
        <div class="text-end mb-3">
            <a href="{{ route('user.withdraw.history') }}" class="btn btn--base">
        ...
        <div class="row justify-content-center">
            ...
            @foreach($withdrawMethod as $data)
                ...
                <div class="col-lg-4 col-md-4 mb-4">
                    <div class="card card-withdraw custom__bg">
                        <h5 class="card-header text-center">{{__($data->name)}}</h5>
                        <div class="card-body card-body-withdraw">
                            <img src="{{getImage(imagePath()['withdraw']['method']['path'].'/'. $data->image,imagePath()['withdraw']['method']['size'])}}" class="card-img-top" alt="{{__($data->name)}}">
                            <ul class="list-group text-center">
                                <li class="list-group-item bg-transparent">@lang('Limit')
                                ...
                                <li class="list-group-item bg-transparent">@lang('Processing Time')
                                    - {{$data->delay}}</li>
                            </ul>
                        </div>
                        <div class="card-footer">
                            <a href="javascript:void(0)"  data-id="{{$data->id}}"
                               ...
                               class="btn btn--base w-100 withdraw" data-bs-toggle="modal" data-bs-target="#withdrawModal">
                                @lang('Withdraw Now')</a>
                        </div>
                    </div>
                </div>
