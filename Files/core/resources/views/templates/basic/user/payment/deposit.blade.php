...
@section('content')
    <div class="container pt-100 pb-100">
        <div class="text-end">
            <a href="{{ route('user.deposit.history') }}" class="btn btn--base my-4">@lang('Deposit History') </a>
        </div>
                    ...
                    <div class="card card-deposit custom__bg">
                        ...
                        <div class="card-footer">
                            <a href="javascript:void(0)" data-id="{{$data->id}}"
                               ...
                               data-percent_charge="{{showAmount($data->percent_charge)}}" class=" btn  btn--base w-100 btn-block custom-success deposit" data-bs-toggle="modal" data-bs-target="#depositModal">
                                @lang('Deposit Now')</a>
                        </div>
                    </div>
                </div>
