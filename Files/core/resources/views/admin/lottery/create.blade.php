                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                <div class="image-upload">
                                    <div class="thumb">
                                        ...
                                        <div class="profilePicPreview" style="background-image: url({{ getImage('',imagePath()['lottery']['size']) }})">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('Your Lottery Title')" name="name" requierd/>
                            </div>
                            <div class="form-group">
                                <label>@lang('Price')</label>
                                <div class="input-group mb-3">
                                  <input type="number" class="form-control" placeholder="@lang('Price')" name="price" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="8" class="form-control nicEdit" placeholder="@lang('Lottery Instruction')" name="detail" requierd></textarea>
                            </div>
                        </div>
                    </div>
                </div>
