    ...
    <div class="row mb-none-30">
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total Buy Ticket')
                            <span class="font-weight-bold"><a href="{{ route('admin.users.tickets',$user->id) }}"> {{$user->lotteryTickets->count()}} @lang('Tickets')</a></span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total Buy Ticket in Amount')
                            <span class="font-weight-bold"><a href="{{ route('admin.users.tickets',$user->id) }}"> {{ getAmount($user->lotteryTickets->sum('total_price'))}} {{ $general->cur_text }}</a></span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total Win Ticket')
                            <span class="font-weight-bold"><a href="{{ route('admin.users.wins',$user->id) }}"> {{$user->wins->count()}} @lang('Tickets')</a></span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total Win Bonus')
                            <span class="font-weight-bold"><a href="{{ route('admin.users.wins',$user->id) }}"> {{$user->wins->sum('win_bonus')}} {{ $general->cur_text }}</a></span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Referred By')
                            <span class="font-weight-bold">@if( $reff != null ) <a href="{{ route('admin.users.detail',$reff->id) }}"> {{ $reff->username }} </a> @else @lang('none') @endif</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total Referral')
                            <span class="font-weight-bold"><a href="{{ route('admin.users.referrals',$user->id) }}"> {{ $user->referral->count() }}</a> </span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total Referral Commissions')
                            <span class="font-weight-bold"><a href="{{ route('admin.users.commissions.deposit',$user->id) }}"> {{ $user->commissions->sum('amount') }} {{ $general->cur_text }} </a></span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--8 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.users.wins',$user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-trophy"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$user->wins->sum('win_bonus')}} {{ $general->cur_text }}</span>
                            </div>
                            <div class="desciption">
