...
<div class="mb-3">
    ...
    @if(request()->routeIs('admin.users.commissions.buy'))
    javascript:void(0)
    @else
    {{ route('admin.users.commissions.buy',$user->id) }}
    @endif
    ...
    ">@lang('Buy Lottery Commission')</a>


    <a href="

    @if(request()->routeIs('admin.users.commissions.win'))
    javascript:void(0)
    @else
    {{ route('admin.users.commissions.win',$user->id) }}
    @endif
